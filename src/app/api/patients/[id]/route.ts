            ...
            if (medicalUpdateFields.length > 0 && patient.medical_history_id) {
                ...
                const createValues = [
                    ...
                    ...medicalFields
                        ...
                        .map((f) => body[f as keyof typeof body]),
                ];
